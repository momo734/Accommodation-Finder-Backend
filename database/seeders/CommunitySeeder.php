...
class CommunitySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $listings = [
            [
                'title' => 'Single Room near Mandalay Palace',
                'city' => 'Mandalay',
                ...
                'description' => 'Bright single room with skyline views, walking distance to Mandalay Palace. Fully furnished, high-speed internet, secure building with 24/7 concierge.',
                'image' => 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&h=560&fit=crop',
            ],
            [
                'title' => 'Shared Room in Bahan, Yangon',
                'city' => 'Yangon',
                'township' => 'Bahan',
                ...
                'bathrooms' => 1,
                'furnishing' => 'Furnished',
                'description' => 'Cozy shared room ideal for students and young professionals. Close to cafes, transit and Shwedagon.',
                'image' => 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800&h=560&fit=crop',
            ],
            [
                'title' => 'Private Room in Kamayut',
                'city' => 'Yangon',
                'township' => 'Kamayut',
                ...
                'bathrooms' => 1,
                'furnishing' => 'Furnished',
                'description' => 'Private room with housekeeping, gym access and flexible lease terms in central Kamayut.',
                'image' => 'https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=800&h=560&fit=crop',
            ],
            [
                'title' => 'Double Room by the riverside',
                'city' => 'Mandalay',
                ...
                'description' => 'Spacious double room with balcony views, parking and peaceful neighbourhood vibes.',
